...
import model.labelprovider.StartPositionLabelProvider;
import model.sorter.ProgElemSorter;

public class MyTableViewer {
   public final static String ID = "project-ex-0130-ast-table-cheng.partdescriptor.simpletableviewast0130cheng";
   public final static String POPUPMENU = "project-ex-0130-ast-table-cheng.popupmenu.0";
   ...
   private void createColumnsProgElem(final Composite parent, final TableViewer viewer) {
      ...
      col.setLabelProvider(new StartPositionLabelProvider());
   }
