...
import model.provider.LabelProviderLocation;
import model.provider.LabelProviderProgElem;
import model.provider.ModelProviderProgElem;

public class Viewer {
   public static final String ID = "project-ex-0309-tree-cheng.partdescriptor.simpleasttreerenamecheng";
   ...
   private void createProgElemColumns() {
      ...
      col.setLabelProvider(new DelegatingStyledCellLabelProvider(new LabelProviderLocation()));
