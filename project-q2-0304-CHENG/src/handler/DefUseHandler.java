...
public class DefUseHandler {
   final String viewId = "project-q2-0304-cheng.partdescriptor.simpleviewq2cheng";
   ...
   protected void displayDefUsedView(SimpleViewer viewer, List<Map<IVariableBinding, DefUseModel>> analysisDataList) {
      viewer.reset();
      int counter = 1;
